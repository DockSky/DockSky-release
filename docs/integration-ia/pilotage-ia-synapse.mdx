...
6. Demande à ton IA : *« Liste les bases MySQL sur docksky-vps (conteneur ctn_mysql) avec le secret MYSQL_ROOT »* — voir [exemple détaillé](./synapse-mcp-cursor#exemple-concret--lister-les-bases-mysql)
